function attenuation = rural_23km_NC_model(airmass)
    %
    ...
    length_1_x = 255.062; %The X projection of the line. Finish-Start.
    length_1_y = 84.375; %The Y projection of the line. Finish-Start.
    y_1_intercept = -32.917; %Distance from 0 dB AirMass of 1 is.    
