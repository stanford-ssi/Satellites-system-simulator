function attenuation = rural_5km_cloudy_model(airmass)
    %
    ...
    length_1_x = 253.98; %The X projection of the line. Finish-Start.
    length_1_y = 226.063; %The Y projection of the line. Finish-Start.
    y_1_intercept = -61.8333; %Distance from 0 dB AirMass of 1 is.    
